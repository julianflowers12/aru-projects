...
library(pacman)
p_load(adehabitatHR, sp, sf, rgdal, tidyverse, stars, sdm, usdm, geojsonio, janitor, raster, mapview, here, ggthemes,ggspatial)
...
d <- sdmData(species ~ b3 + gsw2 + lc1990 + lc2015, train = species, predictors = sc, bg = list(n = 1000, remove = T) )
